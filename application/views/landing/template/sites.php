...
<body>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt text-primary me-3"></i>Jl. Mimpi Indah No. 123 Jakarta, Indonesia</p>
                    <p class="mb-2"><i class="fa fa-phone-alt text-primary me-3"></i>+62 216 1234 5678</p>
                    <p class="mb-2"><i class="fa fa-envelope text-primary me-3"></i>info@jewepedreamweddings.com</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="fw-medium" href="#">Jewepe Dream Weddings</a>, All Right Reserved.
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="<?= base_url('assets/landing/') ?>body>lib/waypoints/waypoints.min.js"></script>
